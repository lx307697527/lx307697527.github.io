...
### [我的博客在这里](http://Liuxpro.github.io)

### [模板在这里](http://huangxuan.me/liuxblog-boilerplate/)

我的博客仓库——`Liuxpro.github.io`，是经常修改的，而且还会有人乱提交代码，因此给大家做了一个稳定版的模板。大家可以直接fork模板——`liuxblog-boilerplate`,要改的地方我都说明了。或者可以直接下载zip到本地自己去修改。
...
* 解决了代码过长自动换行的bug,替换为横向滚动条。详情请见[issue#15](https://github.com/Liuxpro/Liuxpro.github.io/issues/15)
...
* 如果你喜欢我的这个博客模板，请在`Liuxpro.github.io`这个repository点个赞——右上角**star**一下。
...
```
# Site settings
title: Liux Blog             # 你的博客网站标题
SEOTitle: Liux Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: Liuxpro     # 你的github账号
weibo_username: Liuxpro      # 你的微博账号，底部链接会自动更新的。
...
sidebar-avatar: /img/avatar-Liux.jpg     #你的大头贴，请使用绝对地址.
```
...
唯一需要注意的是`featured-condition-size`: A tag will be featured if the size of it is more than this condition value. （也不知道Liux是想表达什么意思，请作者解答）
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了，详情请见：
  [issue #6 ](https://github.com/Liuxpro/Liuxpro.github.io/issues/6) asked, **how to make it looks great?**
...
我的博客标题是 **“Liux Blog”** 但是我想要在搜索的时候显示 **“黄玄的博客 | Liux Blog”** ，这个就需要SEO Title来定义了。
